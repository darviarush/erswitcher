...
* Первая буква не транслитерируется: возможно перезагружен процессор или тормозит само приложение в котором набирается текст.
* В Telegram после транслитерации на русский переключается на английский: пока исправить не удалось.
